...
import type { _SERVICE } from "declarations/metasupply_backend"; // Use alias from tsconfig
import { canisterId as backendCanisterId } from "../services/agent/agent"; // Import from agent.ts where it's defined
